...
def get_all_recent_markets():
    """
    Отримуємо всі ринки у гілці pre-market
    """
    all_markets = []
    offset = 0
    ...
    while True:
        params = {
            "tag_slug": "crypto/pre-market",  # саме ця гілка
            "active": "true",
            "closed": "false",
            "limit": LIMIT,
            "offset": offset,
...
def check_markets():
    ...
    if not markets:
        print(f"⚠️ Немає нових ринків за останні {NEW_DAYS} дні в pre-market")
        return
